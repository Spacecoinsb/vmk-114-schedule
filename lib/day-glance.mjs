import {cleanTitle,teacherRows} from './schedule-model.mjs';
...
export function lessonsOn(schedule,date){
  return schedule.lessons.filter(lesson=>lesson.day===weekday(date)&&active(lesson,date)).sort((a,b)=>a.start.localeCompare(b.start));
}
